...
<img src="markdown_images/pp3-responsive.png" width = 50% height = 50% alt="responsive" />
...
https://aron-hangman.herokuapp.com/
...
* I gave invalid, repetitive and blank inputs to make sure the correct return would be given to the user.
  ...
  <img src="markdown_images/pp3markdown4.png" width = 30% height = 30% alt="4" />
  <img src="markdown_images/pp3markdown5.png" width = 30% height = 30% alt="5" />
  
 ### Bugs

 * I tried on various occasions to impliment an external API Docsheet which would act as a words list for the game to fetch random words from. 
 
   <img src="markdown_images/bug4.png" width = 30% height = 30% alt="4" />

 However I could not on any of those occasions get it to properly connect, even with the help of Code Institute tutors. I therefore decided to create and use an internal 'words.txt' file for the game to fetch words from. Since then no further bugs were identified.

 ## DEPLOYMENT

 The project was deployed using Code Istitute's mock terminal for Heroku.
 ...
 * Click Deploy App 
 ...
 I initially practiced with, and tested my code's functionality on a seperate repository until I was satisfied with my code structure. Once it was satisfactory I copied into this current CI template repository. Therefore you will not see a significant commit history of the run.py file here.

 However, you can look at my commit history for my code here in the hangman.py file

 https://aronm-hangmangamepp3py-y7qvl8wp3g7.ws-eu82.gitpod.io

 This is where I made most of my progress regarding the functionality of my application.

 ## CREDITS

 * My mentor Spencer Barriball, who was critical in leading me in the right direction.
